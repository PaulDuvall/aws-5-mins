...
Go to the [EC2 Console](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Instances:sort=instanceState) and select `InstanceA`, `InstanceB`, and `InstanceC` and view the Security Groups.
