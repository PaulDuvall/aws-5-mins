...
1. Delete linked Account Roles: `aws proton-preview delete-account-roles --region us-west-2`. You can verify by going to [Proton Account role](https://us-west-2.console.aws.amazon.com/proton/home?region=us-west-2#/settings/roles).